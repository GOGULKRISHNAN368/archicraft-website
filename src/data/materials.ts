...
export const materials: Material[] = [
  {
    ...
    description: "Smooth, rich, and sophisticated in appearance.",
    metaDescription:
  ...
  },
  {
    ...
    description: "Elegant textures with practical durability.",
    metaDescription:
  ...
  },
  {
    ...
    description: "A stylish finish with seamless detailing.",
    metaDescription:
  ...
  },
  {
    ...
    description: "Premium high-gloss modern finish.",
    metaDescription:
  ...
  },
  {
    ...
    description: "A refined, premium painted finish delivering exceptional smoothness, vibrant colour, and lasting elegance.",
    metaDescription:
  ...
  },
  {
    ...
    description:
      "Named brand plywood, laminates, hardware, and kitchen appliances: CenturyPly, Greenply, Greenlam, Advance Laminates, Hafele, Hettich, Ebco, Faber, KAFF, Greenlam MiCasa.",
    metaDescription:
